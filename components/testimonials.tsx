        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              ...
              <blockquote className="text-lg text-gray-400 grow">— As a professional UKologist, have I heard about the most compatible pokemon for male human and female poke- Hey, hey wait! WHY ARE YOU LEAVING??</blockquote>
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Blockmaster2706</cite> - <a className="text-teal-300 hover:text-gray-200 transition duration-150 ease-in-out" href="https://solo.to/blockmaster2706">Pro UKologist</a>
              </div>
            </div>
